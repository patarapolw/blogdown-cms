...
div
  b-navbar.is-light
    ...
    template(slot="start")
      ...
      b-navbar-item(tag="router-link" to="/reveal" :class="$route.path === '/reveal' ? 'is-active' : ''") Reveal
      b-navbar-item(tag="router-link" to="/comment" :class="$route.path === '/comment' ? 'is-active' : ''") Comment
